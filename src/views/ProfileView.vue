...
<template>
  <div class="flex h-[100dvh] min-h-0 overflow-hidden bg-slate-50/90 text-slate-900 dark:bg-slate-900 dark:text-white">
    <AppSidebar />
    ...
    <div class="flex min-w-0 flex-1 flex-col lg:pl-[var(--app-sidebar-width)]">
      ...
      <main class="flex min-h-0 flex-1 flex-col gap-8 overflow-y-auto px-4 pb-24 lg:flex-row lg:items-stretch lg:gap-8 lg:overflow-hidden lg:px-10 lg:pb-4">
        <section class="min-h-0 lg:flex-1 lg:overflow-y-auto lg:pr-4">
        ...
        <aside class="flex w-full flex-shrink-0 flex-col gap-4 lg:w-[360px] lg:overflow-y-auto lg:pb-6">
          <div class="p-1">
          ...
          <div class="rounded-2xl p-4 shadow-[0_16px_36px_rgba(244,63,94,0.12)] dark:shadow-[0_16px_36px_rgba(0,0,0,0.3)]">
            <button
